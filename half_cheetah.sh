...
# 경로가 없는 경우 생성
save_path="$EXP_DIR/skill_prior_learning/testmodel/prior_sim2/hetero2/repeat/300"
object_name="half_cheetah_prior_sim2_hetero2"
# Python 스크립트 실행
for j in $(seq 0 3); do
env_name="${object_name}_10_${j}_300"
CUDA_VISIBLE_DEVICES=0 mpirun -np 9 python3 spirl/rl/train_save.py \
        --csv="${object_name}.csv" \
        --path=/home/kangys/workspace/FL_skill/spirl/configs/hrl/half_cheetah/spirl_clg --seed=0 --prefix=$env_name \
