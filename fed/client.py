...
from spirl.utils.pytorch_utils import LossSpikeHook, NanGradHook, NoneGradHook, RAdam
...
class ModelTrainer(BaseTrainer,fl.client.NumPyClient):
...
if __name__ == '__main__':
    client = ModelTrainer(args=get_args()).to_client()
